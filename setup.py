...
build_exe_options = {
    ...
    "packages": ["os", "shutil", "glob", "wx", "numpy","h5py", "cv2", "open3d", "matplotlib", "scipy", ],
    ...
    "include_files": ["calib.json","timesync/","DataClass/","timesync/calib1.h5","timesync/transformation_and_intrinsics7.txt", "timesync/Invilab_ico.ico"],
