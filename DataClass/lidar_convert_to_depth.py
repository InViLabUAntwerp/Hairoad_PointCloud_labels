...
def save_as_ply(XYZ, colors, output_file):
    # Extract X, Y, Z coordinates and colors
    vertices = np.array([tuple(row) for row in XYZ], dtype=[('x', 'f4'), ('y', 'f4'), ('z', 'f4')])
...
if __name__ == "__main__":
    # Example usage
    file_path = r"D:\Hairoad_sync\lidar-data\2024-11-29_12-25-20\test_2024_11_29__12_57_19_419596.bin"
    color_file_path = r"D:\Hairoad_sync\lidar-data\2024-11-29_12-25-20\test_2024_11_29__12_57_19_419596_colors.bin"
    output_file = 'output.ply'

    width = 3
    height = 8857  ## todo: change this to the proper dimensions (read from txt file)
